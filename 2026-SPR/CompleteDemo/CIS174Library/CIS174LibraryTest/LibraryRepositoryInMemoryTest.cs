...
namespace CIS174LibraryTest
{
    ...
    {
        // NOTE: Since this is a file on your computer the data is persistant across tests. This
        // means that if you use the same file name each test will add data and the other tests
        // can see it.

        [TestMethod]
        public void GetAllBooks_HappyPath()
        {
            DbContextOptions<LibraryContext> inmemory = new DbContextOptionsBuilder<LibraryContext>()
